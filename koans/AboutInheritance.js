...
describe("About inheritance", function() {
  ...
  it("should be able to call a method on the derived object", function() { ///// The derived object inherits all the data and member functions of the base class ////
  ...
  it("should set constructor parameters on the base object", function() {
    expect(this.swedishChef.age).toEqual(2); ///// we use constructors for these so look at the new SwedishChef ////
...
describe("About Crockford's inheritance improvement", function() {
  ...
  it("should be able to call a method on the derived object", function() {
    expect(this.gonzo.doTrick()).toEqual("eat a tire"); ///// look at the constructor. Dont really get this one??? ////
  });

  it("should be able to call a method on the base object", function() {
    expect(this.gonzo.answerNanny()).toEqual("Everything's cool!"); /// refer to the .answerNanny from above //// 
  });
